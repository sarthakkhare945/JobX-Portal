...
const Searchbar = ({ handleSearch, handleChange, selection, setSelection }) => {
  ...
  return (
    <div className="flex flex-col flex-wrap md:flex-row gap-5 mt-12">
      {/* Job Role Select */}
      <Select
        name="hiringPosition"
        value={selection.hiringPosition}
        onChange={handleChange}
        className="w-64 h-[50px] pl-4 bg-white font-bold rounded-md text-black outline-none capitalize"
        displayEmpty
      >
      ...
      <Select
        ...
        onChange={handleChange}
        className="w-64 h-[50px] pl-4 bg-white font-bold rounded-md text-black outline-none"
        displayEmpty
      >
        <MenuItem value="" disabled>
          Work Type
      ...
      <button
        ...
        className="w-64 bg-blue-500 rounded-md p-2 font-bold hover:bg-blue-700 text-white"
      >
        Search
      </button>
